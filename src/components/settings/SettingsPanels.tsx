...
export function GeneralSettings() {
  ...
  return (
    <div className="space-y-6">
      <SettingsGroup
        title="Peça ao Mark ✨ (Assistente de IA Integrado)"
        description="O Markd vem equipado com inteligência artificial nativa powered by Google Gemini 3.6 Flash."
      >
        <div className="space-y-4 rounded-xl bg-panel p-4">
          {/* Native Gemini Provider Card */}
          ...
          <div className="pt-1 space-y-3 border-t border-line/50">
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              <Button
                ...
                size="sm"
                className="bg-purple-600 text-white shrink-0 text-xs hover:bg-purple-700"
              >
      ...
      <SettingsGroup
        ...
        description="Selecione o idioma da interface do Markd / Select interface language."
      >
        <div className="flex items-center gap-3 rounded-xl bg-panel p-3">
          <select
            defaultValue="pt-BR"
            onChange={(e) => {
              toast.success(`Idioma alterado para ${e.target.value === "pt-BR" ? "Português (Brasil)" : "English (US)"}`);
            }}
            className="rounded-lg border border-line bg-bg px-3 py-1.5 text-xs text-ink outline-none focus:border-primary"
          >
            <option value="pt-BR">Português (Brasil) — PT-BR</option>
            <option value="en-US">English (US) — EN</option>
          </select>
        </div>
      </SettingsGroup>
