...
function PinnedRow({
  ...
  const deleteEntry = useVault((state) => state.deleteEntry);
              ...
              <>
                <button
                  ...
                  onClick={(e) => {
                    ...
                    void createNote(node.rel);
                  }}
                  className="p-1 text-faint hover:text-ink hover:bg-active rounded transition-colors"
                >
